  ...
  <section class="gallery" id="gallery">
    ...
    <div class="box-container">
      <div class="scrollcat">
        ...
        <div class="box">
          <img src="https://www.goldentours.com/travelblog/wp-content/uploads/2019/12/rsz_cocktail-700x467.jpg" alt="">
          <div class="content">
            <h3>Beverages</h3>
          ...
          <div class="row text-center g-4">
                ...
                <div class="card-body text-center">
                  ...
                  <h4><span class="card-title mb-3"> Rs.<?php echo $item["Price"]; ?> </span></h4>
									...
									<div class="input-group" style="margin-left: 14px; width: 140px;">
										<span class="input-group-text rounded-3" style="font-size: 15px;"><b>Qty</b></span>
										<input style="font-size: 15px;" type="number" class="form-control rounded-3 text-center" id="quantity" name="quantity" value="1" required="required">
									</div>
									<input class="cbtn1 mb-3" type="submit" name="add" style="margin-top:5px; width: 140px; font-weight:700; border-radius: 5%;" class="btn btn-primary btn-sm rounded-5" value="Add to Cart">
									</form>
